...
2. Compila i file Java:
   ```sh
    javac -d out -sourcepath src/main/java src/main/java/com/github/vittoriaalata/callidattilografia/Calli/*.java src/main/java/com/github/vittoriaalata/callidattilografia/Calli/GraphicalProcess.java

3. Esecuzione
   ```sh
   java -cp out com.github.vittoriaalata.callidattilografia.Calli.GraphicalProcess
